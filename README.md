...
CaVa provides investigators, analysts, researchers and websleuths with a local-only environment in which they can manage:
...
* Encrypted vault key derivation and SQLCipher-ready storage
...
| Storage             | SQLite / SQLCipher (planned) |
| Formatting          | Black                        |
